    ...
    return (
        <>
            <div className='container-fluid' style={{  backgroundColor: 'rgba(128, 128, 128, 0.3)' }}>
                <h1 style={{ textAlign: 'center' }}>Contact Us</h1> <hr /> <hr />
                <div className='container'>
                    <h1 style={{ fontWeight: 'bold', textAlign: 'center' }}><i><a className="d-inline-flex align-items-center mb-2 text-body-emphasis text-decoration-none" href="/" aria-label="Bootstrap">
                    ...
                    </a> BIJOY eComm. Store</i></h1>
                    <br />
                    <br />  
                    <h3 style={{ fontWeight: 'bold' }}><i>Owner Name: Bijoy Chowdhury</i></h3>
                    <h3>Email: chowdhury@gmail.com</h3>
                    <h3>Main Office Address: Agargaon Road, Dhaka, Bangladesh. Motaleb plaza, 1st floor.</h3>
                    <h3>Phone No. : 01799999999, 01600000000</h3>
                    <br />
                    <h3>GM: Anisul Haque</h3>
                    <h3>Any problem to call customar service.</h3>
                    <h4>customar service number: 015000000000, 019000000000, 014000000000</h4>
                </div>
                <div>
