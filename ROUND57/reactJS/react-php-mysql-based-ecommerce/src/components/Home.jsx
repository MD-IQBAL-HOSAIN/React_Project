...
import slide2 from '../assets/women5.jpg';
import slide3 from '../assets/slide3.png';
import slide4 from '../assets/men5.webp';
import men4 from '../assets/men4.jpg';
import sports from '../assets/sports2.webp';
import electronics from '../assets/electronics5.jpg';
import mobile from '../assets/electronics1.png';
import women from '../assets/women4.jpg';
import cattle from '../assets/cattle1.webp';
...
const Home = () => {
    ...
    const categories = [
        { name: 'Cat-1: Electronics', image: electronics },
        { name: 'Cat-2: Mobile', image: mobile },
        { name: 'Cat-3: Men Cloth', image: men4 },
        { name: 'Cat-4: Women Cloth', image: women },
        { name: 'Cat-5: Sports Item', image: sports },
        { name: 'Cat-6: Cattle', image: cattle }
    ];
    ...
    return (
        <div style={{ backgroundColor: 'rgba(128, 128, 128, 0.3)' }}>
                ...
                <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
                    <div className="carousel-inner">
                        <div className="carousel-item active" data-bs-interval="1000">
                            <img src={slide4} className="d-block w-100" style={imageStyle} alt="Slide 1" />
                        </div>
                        <div className="carousel-item" data-bs-interval="2000">
                            <img src={slide2} className="d-block w-100" style={imageStyle} alt="Slide 2" />
                        </div>
                        <div className="carousel-item" data-bs-interval='2000'>
                            <img src={slide3} className="d-block w-100" style={imageStyle} alt="Slide 3" />
                        </div>
                        <div className="carousel-item" data-bs-interval='2000'>
                            <img src={sports} className="d-block w-100" style={imageStyle} alt="Slide 4" />
                        </div>
                    </div>
            ...
            <div className="container-fluid mt-4">
                <h1 style={{ fontWeight: 'bold', boxShadow: '0px 2px 4px rgba(0, 0, 0, 0.3)' ,fontSize: '30px',textAlign: 'center', padding: '10px',backgroundColor: 'white'}}>Categories of BIJOY eComm. Store</h1>
